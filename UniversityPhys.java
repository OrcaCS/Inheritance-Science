/**
 * UniversityPhys class, extends SeniorPhys. Grade calculator and general
 * minimum high school grades for university physics.
 * 
 * @author Stephanie Hu
...
public class UniversityPhys extends SeniorPhys {
    ...
    /**
     * Prints pass or fail for senior physics (SPH4U) and university physics
     * eligibility.
     */
    protected void universityPhysicsEligibility() {
        if (physGrade >= 50) {
            System.out.println(
                    "You passed SPH4U. Please check the other course requirements for your university of choice.");
        } else {
